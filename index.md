  ...
  <div class="grid">
    <div class="card soft col-12">
      ...
      <div class="btnrow">
        ...
        <a class="btn" href="{{ '/access-training/' | relative_url }}">User Training & Access</a>
  ...
  <div class="grid">
    <div class="card col-6">
      ...
      <ul class="bullets">
        ...
        <li>Academic researchers and research groups</li>
        <li>Industry collaborators and startups</li>
        <li>External academic partners</li>
      </ul>
      <p class="muted" style="margin-top:12px;">New users are welcome. Training and onboarding are provided based on your project needs and experience level.</p>
    </div>
    <div class="card col-6">
...
<section id="what-we-offer-summary">
  <div class="grid">
    <div class="card col-7">
      <h2>What can you do here?</h2>
      <ul class="bullets">
        <li>Fabricate micro- and nano-scale structures</li>
        <li>Rapidly prototype custom mechanical and polymer parts</li>
        <li>Functionalize surfaces for biological applications</li>
        <li>Assemble and package devices</li>
        <li>Characterize materials and finished devices</li>
        <li>Receive design and process support from experienced staff</li>
      </ul>
      <div class="btnrow">
        <a class="btn primary" href="{{ '/what-we-offer/' | relative_url }}">Explore Capabilities</a>
      </div>
    </div>
  ...
  <div class="grid">
    <div class="card col-7">
      ...
      <ol class="steps">
        ...
        <li>Book equipment or request services</li>
      </ol>
      <div class="btnrow">
        <a class="btn primary" href="{{ '/access-training/' | relative_url }}">User Training & Access</a>
        <a class="btn" href="{{ '/services-pricing/' | relative_url }}">Fees & Pricing</a>
      </div>
    </div>
    <div class="card soft col-5">
      <h2>Returning users</h2>
      <p class="muted">If you already have access, use ColabMacs Login to manage training status, bookings, and account details.</p>
      <div class="btnrow">
